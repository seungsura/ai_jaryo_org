...
```text
Use $image-creator-gpt-image to make a README workflow image and save it to docs/assets/workflow.png.
```
...
```bash
python3 .codex/skills/vendor/image-creator-gpt-image/scripts/save_generated_image.py --since "$START_EPOCH" --destination <path>
```
